        ...
        <div class="footer-grid">
          <div class="footer-brand">
            <a class="footer-logo" style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px; text-decoration: none;" data-route="/" href="/">
              <img src="/images/logo.webp" alt="Cresenix Solutions Logo" style="height: 36px; width: auto; object-fit: contain;" />
          ...
          <div class="footer-column">
            ...
            <a class="footer-link" data-route="/blog" href="/blog">Blog</a>
